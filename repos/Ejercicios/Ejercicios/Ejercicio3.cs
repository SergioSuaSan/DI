...
namespace Ejercicios.Ejercicios
{
    ...
    {
        /**
         * <summary> Método que realiza la opción 3 del menú,
         * para ello usará la llamada a la función recursiva Fibo </summary>
         * <returns>No recibe ni devuelve ningún valor</returns>
         * 
         * 
         * 
         */
        ...
        */
        public string Fibo(int i, int n, int f1, int f2)
        {
            ...
            //Si el número es negativo, lo indico y termino el ejercicio devolviendo al menú principal
            else
            {
                return "El número elegido no puede ser negativo";
            }
        }
